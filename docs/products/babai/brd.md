...
| `execution-plan.md` | October–December quality-first execution plan, milestones, bot-health, gates, pipeline and internal budget views. |
| `flow-inventory.md` | Fourteen product flow requirements with source citations, acceptance boundaries and implementation/demo status. |
