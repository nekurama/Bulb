...
they are not current pilot taxonomy. The 10-restaurant figure is a validation
hypothesis and eventual readiness ceiling, not simultaneous founder-supported
enrollment; operate a controlled one-to-three-restaurant cohort at a time.
Identify records with **Pilot Variant A/B/C** or a functional scope
description. These labels are for evidence collection only and do not define
packages, tiers or public pricing. [Current founder correction:
