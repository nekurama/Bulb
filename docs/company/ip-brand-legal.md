...
The current packet narrows that rule: NEKURAMA owns only new work intentionally created for
NEKURAMA/BABAI and properly adopted by the company after incorporation. Employer, third-party,
customer and unrelated personal IP remains excluded.

Defer major contracts, hiring and IP-transfer commitments until incorporation. After the
certificate, execute founder/company adoption documents and then proceed with material contracts.
...
- [ ] **professional-validation-required** Incorporation/legal entity details and the transition-point evidence
- [ ] **professional-validation-required** Founder/company adoption, confidentiality and IP documents after incorporation
...
- [ ] Domain ownership/registration policy, including migration of founder-owned recovery and billing controls
...
- [ ] **Founder/IP evidence:** after incorporation, execute founder/company adoption and confidentiality documents; keep a pre-incorporation exclusion schedule and list `nekurama.com` as an asset requiring control transfer if acquired pre-incorporation.
...
- [ ] **Clean room:** company ownership is limited to new NEKURAMA/BABAI work; prohibit employer-confidential, customer-confidential, restricted third-party and unrelated personal material unless rights are documented and professionally reviewed.
...
- [ ] **Contracts:** defer major contracts until incorporation; then prepare and legally review customer agreement/ToS, privacy notice, DPA/data-use terms, vendor terms and IP warranties before the first paying customer.
...
- **partial:** the IP taxonomy and intended ownership boundary exist, but no complete provenance register, post-incorporation adoption set or clearance report is recorded here.
